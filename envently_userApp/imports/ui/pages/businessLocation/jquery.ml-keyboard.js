...
Key.prototype.setCurrentAction = function() {
  ...
  this.$key.unbind("click.slkeyboard");
  this.$key.bind("click.slkeyboard", function(){
...
KeyTab.prototype.defaultClickAction = function() {
  ...
  // console.log("key pressed ======> ", $(":input").eq($(":input").index(this.keyboard.$current_input)+1))
};

  function KeyCapsLock() {
  Key.call(this, arguments);

  this.id = "slkeyboard-capslock";
...
KeyEnter.prototype.defaultClickAction = function() {
  ...
  this.keyboard.$current_input.parents('form').submit();
  this.keyboard.hideKeyboard();
};
  function KeyShift() {
  Key.call(this, arguments);

  this.id = "slkeyboard-"+arguments[1]+"-shift";
...
function Keyboard(selector, options){
  ...
  this.$keyboard = $("<div/>").attr("id", "slkeyboard");
  this.$modifications_holder = $("<ul/>").addClass('slkeyboard-modifications');
...
Keyboard.prototype.setUpKeys = function() {
  ...
  $.each(this.keys, function(i, key){
    ...
    key.preferences = slKeyboard.layouts[_this.options.layout][i];
    key.setCurrentValue();
...
Keyboard.prototype.hideIfInactive = function() {
...
Keyboard.prototype.inputLocalOptions = function() {
  ...
  for (var key in this.defaults) {
    var input_option = this.$current_input.attr("data-slkeyboard-"+key);
...
Keyboard.prototype.changeKeysState = function() {
  ...
  $.fn.slKeyboard = function(options) {
...
var slKeyboard = slKeyboard || {layouts: {}};

slKeyboard.layouts.en_US = [
  {d: '`', u: '~'},
  {d: '1',u: '!'},
  {d: '2',u: '@'},
  {d: '3',u: '#'},
